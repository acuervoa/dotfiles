...
- [x] **Step 5: Capture baseline and add CI**
...
- [x] **Step 2: Run and record baseline**
...
- [x] **Step 1: Add non-mutating workflow contracts**
...
- [x] **Step 2: Document exact workflows**
...
- [x] **Step 1: Capture five-run measurements**
...
- [x] **Step 4: Verify and commit conditionally**
...
- [x] **Step 2: Check protected paths and generated drift**
