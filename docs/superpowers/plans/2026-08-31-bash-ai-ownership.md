...
- [x] **Step 1: Write the static ownership test**
...
- [x] **Step 2: Add the reload contract test**
...
- [x] **Step 1: Move the `.bashrc`-only functions**
...
- [x] **Step 2: Add discoverability annotations**
...
- [x] **Step 1: Delete only the AI block**
...
- [x] **Step 2: Verify the real runtime without printing local values**
