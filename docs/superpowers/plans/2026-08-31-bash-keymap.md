...
- [x] **Step 1: Test Readline owner contract**
...
- [x] **Step 2: Test reload idempotence**
...
- [x] **Step 3: Test missing optional tools**
...
- [x] **Step 1: Define guarded Readline wrappers**
...
- [x] **Step 2: Define Readline bindings**
...
- [x] **Step 4: Validate the focused test**
...
- [x] **Step 1: Remove inline key ownership**
...
- [x] **Step 2: Source `keymap.sh` after integrations**
...
- [x] **Step 3: Preserve startup behavior**
...
- [x] **Step 1: Verify effective Readline bindings**
...
- [x] **Step 3: Check scope and tmux safety**
