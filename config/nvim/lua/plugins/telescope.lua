  ...
  config = function()
    ...
    telescope.setup({
      defaults = {
        ...
        layout_config = { horizontal = { prompt_position = "top", preview_width = 0.55 }, width = 0.87, height = 0.80, preview_cutoff = 120 },
        sorting_strategy = "ascending",
        file_ignore_patterns = { "node_modules",".git/","vendor/" },
        mappings = { i = { ["<C-n>"]=actions.move_selection_next, ["<C-p>"]=actions.move_selection_previous, ["<C-u>"]=false, ["<C-d>"]=false, ["<esc>"]=actions.close } },
      },
